...
CREATE TABLE users (
    ...
    -- Phân quyền
    system_role     VARCHAR(20)  NOT NULL DEFAULT 'STAFF',
    ...
    CONSTRAINT chk_users_sys_role   CHECK  (system_role IN ('SUPER_ADMIN','MANAGER','STAFF'))
);
...
CREATE TABLE workflow_versions (
    ...
    CONSTRAINT uq_wv_version     UNIQUE (workflow_id, version_number),
...
CREATE TABLE workflow_stages (
    ...
    CONSTRAINT uq_wfstages_seq     UNIQUE (workflow_id, version_id, sequence),
    CONSTRAINT uq_wfstages_code    UNIQUE (workflow_id, version_id, code),
...
CREATE TABLE workflow_transitions (
    ...
    CONSTRAINT uq_wt_from_to     UNIQUE (workflow_id, version_id, from_stage_id, to_stage_id),
...
CREATE TABLE doc_types (
    ...
    CONSTRAINT uq_doc_types_name UNIQUE (name)
);
...
CREATE TABLE stage_doc_rules (
    ...
    CONSTRAINT uq_sdr_stage_doc UNIQUE (stage_id, doc_type_id)
);
...
-- -------------------------------------------------------
-- 1.9  project_checklist_status  –  Trạng thái Checklist theo Dự án
-- -------------------------------------------------------
...
-- -------------------------------------------------------
-- 1.10  stage_notifications  –  Cấu hình Thông báo theo Bước
-- -------------------------------------------------------
...
CREATE TABLE projects (
    ...
    CONSTRAINT chk_projects_status    CHECK (status IN ('ACTIVE','WON','LOST','CANCELLED','ARCHIVED'))
);
...
CREATE TABLE rfq_vendors (
    ...
    CONSTRAINT uq_rv_rfq_email  UNIQUE (rfq_id, vendor_email),
...
CREATE TABLE magic_links (
    ...
    CONSTRAINT uq_ml_token      UNIQUE (token),
...
CREATE TABLE quotation_line_items (
    ...
    CONSTRAINT uq_qli_quot_item  UNIQUE (quotation_id, rfq_item_id)
);
...
CREATE TABLE shipments (
    ...
    CONSTRAINT uq_s_bl          UNIQUE (bl_number),
...
CREATE TABLE user_sessions (
    ...
    CONSTRAINT uq_us_session    UNIQUE (session_token),
...
CREATE TABLE system_settings (
    ...
    CONSTRAINT uq_ss_key        UNIQUE (setting_key),
...
-- THỐNG KÊ SCHEMA
-- ============================================================
-- Tổng: 30 bảng + 3 triggers + 2 views
--
-- PHÂN HỆ 1 - Nền tảng (16 bảng):
--   users, workflows, workflow_versions, workflow_stages,
--   workflow_transitions, doc_types, stage_doc_rules,
--   stage_checklist_items, project_checklist_status,
--   stage_notifications, projects, project_members,
--   project_documents, document_audit_logs,
--   project_transition_logs, project_comments
--
-- PHÂN HỆ 2 - Sourcing (7 bảng):
--   rfqs, rfq_evaluation_criteria, rfq_line_items,
--   rfq_vendors, magic_links, quotations,
--   quotation_line_items
--
-- PHÂN HỆ 3 - Operations (4 bảng):
--   workflow_stage_tasks, project_tasks,
--   shipments, shipment_milestones, shipment_costs
--
