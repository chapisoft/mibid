...
import { Department, TenantAccount, TenantAccountStatus, UserAccount, UserRole, UserAccountStatus } from '../../shared/types';
  ...
  const userColumns: Column<UserAccount>[] = [
    ...
    },
    {
      ...
      render: (item) => (
        ...
        >
          {item.status === UserAccountStatus.INACTIVE ? t.common.lockedStatus : t.common.activeStatus}
        </span>
      ),
    },
  ];
