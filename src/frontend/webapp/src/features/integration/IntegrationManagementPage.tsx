...
export function IntegrationManagementPage() {
  ...
  const handleSaveEndpoint = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(err.message || t.integration.test_failed);
    }
  };
        ...
        <div className="flex items-center gap-3 self-stretch md:self-auto">
          <button
            onClick={() => {
              setEditingEndpoint({
                name: '',
                systemType: SystemType.SAP_ERP,
                integrationMode: IntegrationMode.KAFKA_STREAMING,
                endpointUrl: '',
                    ...
                    <td className="py-3.5 px-4">
                      <span
                        className={`inline-block px-2.5 py-1 rounded-full text-xs font-semibold whitespace-nowrap ${
                          log.status === FileSyncStatus.SUCCESS
            ...
            <form onSubmit={handleSaveEndpoint} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    value={editingEndpoint.systemType || SystemType.SAP_ERP}
                ...
                <div>
                  ...
                  <select
                    value={editingEndpoint.integrationMode || IntegrationMode.KAFKA_STREAMING}
