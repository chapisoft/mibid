      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 flex h-[68px] items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 shrink-0">
          ...
          <button
            ...
            onClick={() => handleSelect(isAuthenticated ? 'dashboard' : 'home')}
          >
            <MibidLogo size="md" />
          </button>
        </div>
        ...
        <nav className="hidden lg:flex items-center gap-1.5">
          {/* Khi CHƯA đăng nhập: Hiện nút Trang chủ */}
          {!isAuthenticated && (
            <button
              type="button"
          ...
          {/* Khi ĐÃ đăng nhập: Bỏ Trang chủ, hiển thị "Tổng quan" đầu tiên và các nhóm nghiệp vụ */}
          {isAuthenticated && (
            <>
              {/* Nút Tổng quan Pill */}
              <button
