  ...
  const handleAddShipment = async (e: React.FormEvent) => {
    ...
    const created = await logisticsService.addShipment({
      ...
      cargoItems: [
        {
          id: `cg-${Date.now()}-1`,
          itemCode: 'ITEM-EXP-01',
          itemName: formCargoSummary || 'Lô thiết bị chính theo BoQ hợp đồng',
          specification: 'Tiêu chuẩn kỹ thuật nghiệm thu quốc tế',
          quantity: 1,
          unit: 'Lô',
          containerNo: 'CONTAINER-AUTO-01',
          sealNo: 'SEAL-VN-2026',
          grossWeightKg: 35000,
        },
      ],
      milestones: [
        {
          id: `ms-${Date.now()}-1`,
          stepName: 'Ký Hợp đồng & Đặt hàng PO với Nhà máy',
          plannedDate: formEtd,
          actualDate: formEtd,
          status: 'COMPLETED',
          location: formOriginPort,
        },
        {
          id: `ms-${Date.now()}-2`,
          stepName: 'Khởi hành rời Cảng xuất (ETD)',
          plannedDate: formEtd,
          actualDate: formEtd,
          status: 'IN_PROGRESS',
          location: formOriginPort,
        ...
        {
          id: `ms-${Date.now()}-3`,
          stepName: 'Cập Cảng đích & Làm thủ tục Hải quan (ETA)',
          plannedDate: formEta,
          status: 'PENDING',
          location: formDestPort,
        },
        {
          id: `ms-${Date.now()}-4`,
          stepName: 'Bàn giao nghiệm thu tại Công trường',
          plannedDate: formContractDeadline,
          status: 'PENDING',
          location: 'Kho Công Trường',
        },
      ],
      documents: [
        {
